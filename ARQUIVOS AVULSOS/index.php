...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="busca" class="input-group">
            <input type="text" class="form-control" placeholder="O Senhor dos Anéis: A Sociedade do Anel" aria-label="Text input with 2 dropdown buttons">
            <button class="btn btn-outline-secondary" type="button" aria-expanded="false"><i class="fas fa-search"></i></button>
        </div>
        <!-- Section-->
        <section class="py-5">
