    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="index.php"><img alt="logomarca loca livros" src="assets/localivros.png" width="70%"></a>
        ...
        <div id="busca" class="input-group">
            ...
            <button class="btn btn-outline-secondary" type="button" aria-expanded="false">Procurar</button>
        </div>
        <!-- Section-->
        <section class="py-5">
        ...
        <footer class="py-5 bg-dark">
            <div class="container">
                <div class="row">
                    <div class="col-4">
                        <img alt="logomarca loca livros" src="assets/localivros-branco.png" width="70px">
                    </div>
                    <div class="col-8">
